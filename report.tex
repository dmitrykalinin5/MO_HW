...
\begin{figure}[H]
  ...
  \caption{Покоординатный спуск: ломаная идет параллельно координатным осям.}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.82\textwidth]{dz2_gradient_descent.png}
  \caption{Градиентный спуск с дроблением шага.}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.82\textwidth]{dz2_steepest_descent.png}
  \caption{Наискорейший спуск с точным выбором шага вдоль антиградиента.}
\end{figure}
